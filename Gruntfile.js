module.exports = function(grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'rising_sphinx_theme/static/fonts/FreightSans',
              filter: 'isFile'
          },

          {
              ...
              dest: 'rising_sphinx_theme/static/fonts/IBMPlexMono',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
              ...
              flatten: true,
              src: ['images/*'],
              dest: 'rising_sphinx_theme/static/images',
              filter: 'isFile'
          }
        ]
      },
      ...
      vendor: {
        files: [
...

          {
            ...
            dest: 'rising_sphinx_theme/static/js/vendor',
            filter: 'isFile'
          }
        ]
      }
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'scss',
          src: ['*.scss'],
          dest: 'rising_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    postcss: {
      ...
      dist: {
        files: {
          "rising_sphinx_theme/static/css/theme.css": "rising_sphinx_theme/static/css/theme.css"
        }
      }
    },
    ...
    browserify: {
      dev: {
        options: {
          external: ['jquery'],
          alias: {
            'rising-sphinx-theme': './js/theme.js'
          }
        },
        src: ['js/*.js'],
        dest: 'rising_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    watch: {
      ...
      sphinx: {
        files: ['rising_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
